...
@pytest.mark.asyncio
def test_rs_bool_truthy(mocker, async_client_mock, async_rs_factory):
    mocker.patch(
...
def test_rs_bool_falsy(mocker, async_client_mock, async_rs_factory):
    mocker.patch(
        'connect.client.models.resourceset.parse_content_range',
...
def test_rs_getitem(mocker, async_client_mock, async_rs_factory):
    mocker.patch(
        'connect.client.models.resourceset.parse_content_range',
        return_value=ContentRange(0, 9, 10),
    )
...
def test_rs_values_list_evaluated(mocker, async_client_mock, async_rs_factory):
    mocker.patch(
        'connect.client.models.resourceset.parse_content_range',
        return_value=ContentRange(0, 9, 10),
    )
...
@pytest.mark.asyncio
def test_rs_with_queries(mocker, async_client_mock, async_rs_factory):
    mocker.patch(
        'connect.client.models.resourceset.parse_content_range',
        return_value=ContentRange(0, 0, 0),
    )
...
def test_rs_bool_truthy_already_evaluated(mocker, async_client_mock, async_rs_factory):
    mocker.patch(
        'connect.client.models.resourceset.parse_content_range',
        return_value=ContentRange(0, 9, 10),
    )
    ...
    mocked = mocker.patch.object(AsyncResourceSet, '_execute_request', wraps=rs._execute_request)
    rs._client.get.return_value = expected
    assert bool(rs) is True
    assert bool(rs) is True
...
# def test_rs_count_already_evaluated(mocker, async_client_mock, async_rs_factory):
#     mocker.patch(
#         'connect.client.models.resourceset.parse_content_range',
#         return_value=ContentRange(0, 9, 10),
#     )
...
def test_rs_slice_already_evaluated(mocker, async_client_mock, async_rs_factory):
    mocker.patch(
        'connect.client.models.resourceset.parse_content_range',
        return_value=ContentRange(0, 9, 10),
    )
